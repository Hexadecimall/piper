...
class property(DynamicClassAttribute):
    """
    This descriptor defines attributes with separate behavior
...
class EnumType(type):
    ...
    def __new__(metacls, cls, bases, classdict, *, boundary=None, _simple=False, **kwds):
        ...
        if Enum is not None:
            # save a locally defined __new__ before it gets
    ...
    def _find_new_(mcls, classdict, member_type, first_enum):
        ...
        # locally; also check earlier enum classes in case a __new__ was
